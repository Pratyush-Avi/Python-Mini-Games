...
There is also an ‘__init__’ which is a reserved method in python. It other words it is a constructor. When this method is called an object is created from the class and it allows the class to initialize the attributes of the class.
